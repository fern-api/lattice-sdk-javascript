...
export class OAuth2 {
    protected readonly _options: OAuth2.Options;

    constructor(_options: OAuth2.Options = {}) {
     ...
     * @param {OAuth2.RequestOptions} requestOptions - Request-specific configuration.
     *
